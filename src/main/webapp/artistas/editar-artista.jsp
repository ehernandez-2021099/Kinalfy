                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4 mb-4">
                                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletArtistas?accion=listar">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/ServletArtistas"  class="was-validated">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="${artista.id}" readonly="true">
                                </div>
                                ...
                                <div class="mb-3">
                                    <label for="infoArtistaId" class="col-form-label">Cantidad de Canciones:</label>
                                    <input type="text" class="form-control" id="infoArtistaId" name="infoArtistaId" value="${artista.getInfoArtistaId()}" required>
                                </div>
                            ...
                            <div class="container mb-2">
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <a class="btn btn-danger"href="${pageContext.request.contextPath}/ServletArtistas?accion=eliminar&id=${artista.id}"> 
                                            <i class="fa-solid fa-trash"></i> Eliminar Artistas
                                        </a>
                                    </div>
