                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/ServletGenero"  class="was-validated">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="${genero.id}" required>
                                </div>
                            ...
                            <div class="container mb-2">
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <a class="btn btn-danger"href="${pageContext.request.contextPath}/ServletGenero?accion=eliminar&id=${genero.id}"> 
