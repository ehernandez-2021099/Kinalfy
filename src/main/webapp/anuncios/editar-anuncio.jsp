                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/ServletAnuncios"  class="was-validated">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="${anuncio.id}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="nombre" class="col-form-label">Nombre:</label>
                                    <input type="text" class="form-control" id="nombre" name="nombre" value="${anuncio.descripcion}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="cantidadCanciones" class="col-form-label">Imagen: </label>
                                    <input type="url" class="form-control" id="url" name="url" value="${anuncio.urlImage}" required>
                                </div>
                            ...
                            <div class="container mb-2">
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <a class="btn btn-danger"href="${pageContext.request.contextPath}/ServletAnuncios?accion=eliminar&id=${anuncio.id}"> 
