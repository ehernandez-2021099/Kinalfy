                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4 mb-4">
                                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletLista?accion=listar">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/ServletLista"  class="was-validated">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="${lista.id}" readonly="true">
                                </div>

                                <div class="mb-3">
                                    <label for="idAsig" class="col-form-label">ID Asignacion Anuncio:</label>
                                    <input type="number" class="form-control" id="cancionId" name="cancionId" value="${lista.getCancionId()}" required>
                                </div>
                                <div class="mb-3">
                                    <label for="cancionId" class="col-form-label">ID Cancion:</label>
                                    
                                    <input type="number" class="form-control" id="idAsig" name="idAsig" value="${lista.getAsignacionAnuncioId()}" required>
                                </div>
                            ...
                            <div class="container mb-2">
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <a class="btn btn-danger"href="${pageContext.request.contextPath}/ServletLista?accion=eliminar&carne=${lista.id}"> 
