                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col-4 mb-4">
                                        <a class="btn btn-secondary" href="${pageContext.request.contextPath}/ServletPlanes?accion=listar">
                        ...
                        <form method="POST" action="${pageContext.request.contextPath}/ServletPlanes"  class="was-validated">
                            ...
                            <div class="modal-body ">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="id" name="id" value="${plan.id}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="nombre" class="col-form-label">Nombre:</label>
                                    <input type="text" class="form-control" id="nombre" name="nombre" value="${plan.nombrePlan}" required>
                                </div>
                                <div class="mb-3">
                            ...
                            <div class="container mb-2">
                                <div class="row">
                                    <div class="col-6 text-center">
                                        <a class="btn btn-danger"href="${pageContext.request.contextPath}/ServletPlanes?accion=eliminar&id=${plan.id}"> 
                                            <i class="fa-solid fa-trash"></i> Eliminar Planes
                                        </a>
                                    </div>
