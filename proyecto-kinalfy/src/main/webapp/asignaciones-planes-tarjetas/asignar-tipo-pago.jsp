<%-- 
    Document   : asignar-tipo-pago
    Created on : 25 ago 2022, 8:18:01
    Author     : informatica
--%>
                            ...
                            <div class="col-12 col-md-12 col-lg-12 ">
                                    ...
                                    <div id="openModal" class="modalDialog scol-12 col-md-12">
                                        ...
                                        <div class="login-page-content">
                                            ...
                                            <form action="#" class="login-page-form">
                                                ...
                                                <input type="password" class="form-login-input" placeholder="Password">

                                                <button type="button" class="btn btn-primary">Login</button>

                                                <a href="#" class="form-login-link col-12 col-md-12"> Having trouble
                                                    logging in?</a>
                                                <p>or</p>
                                ...
                                <form class="row g-3 needs-validation " novalidate id="form">
                                    ...
                                    <div id="buttom" class="col-12 col-md-12">
                                        <button id="botonProbar" class="btn btn-outline-success" type="submit"onclick="myFunction()"
                                            type="submit">
                                            Probar ahora</button>
